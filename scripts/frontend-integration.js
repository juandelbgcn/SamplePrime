 ...
 * This file demonstrates how to integrate Sampleprime with a web frontend
 */

// For React/Vue/Angular applications
export class SampleprimeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SampleprimeClient(provider, contractAddress);
