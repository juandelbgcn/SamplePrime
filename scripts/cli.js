...
const contractABI = require("../artifacts/contracts/Sampleprime.sol/Sampleprime.json").abi;

program
    .name("sampleprime-cli")
    .description("CLI tool for Sampleprime smart contract")
    .version("1.0.0");
